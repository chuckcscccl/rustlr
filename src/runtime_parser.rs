...
/// and used in conjuction with [RuntimeParser::parse_core].  *This type
/// is being deprecated in favor of the [ErrHandler] trait, which offers
/// greated flexibility in customizing the parser*.
